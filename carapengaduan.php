...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <body style="background:white;">
                        ...
                        <h2 style="margin-top:5%; margin-left:20px;">Cara Menggunakan Layanan Pengaduan </h2>
                        <br>
                            <img src="img/carapengaduan.jpg" width="60%" class="img-responsive" alt="Responsive image" style="margin-left:20px;">
                        <br>
                        <br>
                            <p>1.Klik aktivasi agar dapat aktivasi akun untuk login ke aplikasi</p>
                            <p>2.Masukan Username dan Password untuk login ke aplikasi</p>
                            <p>3.Masuk ke halaman nomor peserta untuk mengisi kelengkapan data peserta</p>
                            <p>4.Buka halaman layanan Call Center di navigasi layanan untuk melakukan kontak dengan Customer Service</p>
                            <p>5.Buka halaman layanan pengaduan di navigasi layanan untuk menggunakan layanan</p>
                            <p>6.Isi form pegaduan secara lengkap bila sudah melakukan kontak dengan customer service</p>
                            <p>7.Selesai dan proses pengaduan terkirim</p>
