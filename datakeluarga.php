...
<br>
  ...
  <ul class="nav nav-pills">
    ...
    <li class="active"><a href="datakeluarga.php">DATA KELUARGA</a></li>
  </ul>
</div>
<br>
<br>
...
<div class="container">
		<div class="panel panel-fkefkedjdegjrngkjlnbkjngerkjbfrkjbfdefault">
			<div class="panel-heading clearfix"><i class="fa fa-fw fa-globe"></i> <strong>Browse Data Keluarga</strong> <a href="tambah4.php" class="pull-right btn btn-danger btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Tambah Data</a></div>
                ...
                <tbody>
                  ...
                  ?> 
                    <tr>
						...
						<td><?php echo $row['nama_pasangan'];?></td>
						<td><?php echo $row['nama_ibu_kandung'];?></td>
						<td><?php echo $row['jumlah_anak'];?></td>
						<td align="center">
							<a href="edit4.php?nik=<?php echo $row['nik'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> |<br> 
							<a href="hapus4.php?nik=<?php echo $row['nik'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this user?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
						</td>
					 </tr>
                  <?php
                  }
