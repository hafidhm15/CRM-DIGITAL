...
<br>
  ...
  <ul class="nav nav-pills">
    <li class="active"><a href="datapeserta.php">DATA INDIVIDU</a></li>
...
<div class="container">
		<div class="panel panel-fkefkedjdegjrngkjlnbkjngerkjbfrkjbfdefault">
			<div class="panel-heading clearfix"><i class="fa fa-fw fa-globe"></i> <strong>Browse Data Individu</strong> <a href="tambah1.php" class="pull-right btn btn-danger btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Tambah Data</a></div>
                ...
                <tbody>
                  ...
                  ?> 
                    <tr>
						...
						<td align="center">
							<a href="edit1.php?nomor_peserta=<?php echo $row['nomor_peserta'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> |<br> 
							<a href="hapus1.php?nomor_peserta=<?php echo $row['nomor_peserta'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this user?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
						</td>
					 </tr>
                  <?php
                  }
