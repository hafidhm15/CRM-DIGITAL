...
<br>
	<div class="container">
		...
		<h1><a href="https://learncodeweb.com/php/php-crud-in-bootstrap-3-with-a-search-functionality/">Edit Data Keluarga</a></h1>
        ...
        <?php
			...
			$nik = $_GET['nik'];				
			$query_mysql = mysql_query("SELECT * FROM data_keluarga WHERE nik='$nik'")or die(mysql_error());
			while($row = mysql_fetch_array($query_mysql)){
			?>
	<div class="panel panel-default">
			<div class="panel-heading clearfix"><i class="fa fa-fw fa-plus-circle"></i> <strong>Tambah Data Data</strong> <a href="datapekerjaan.php" class="pull-right btn btn-danger btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Data Keluarga </a></div>
			<div class="panel-body">
				<div class="col-sm-6">
					<form action="edit4-proses.php" method="post">
                        ...
                        <div class="form-group">
							...
							<input type="text" name="nomor_kk" id="nomor_kk" class="form-control" value="<?php echo $row['nomor_kk']; ?>">
						</div>
                        <div class="form-group">
							<label>Hubungan Keluarga  <span class="text-danger">*</span></label>
							<input type="text" name="hubungan_keluarga" id="jabatan" class="form-control" value="<?php echo $row['hubungan_keluarga']; ?>">
						</div> 
                        <div class="form-group">
							<label>Nama Pasangan <span class="text-danger">*</span></label>
							<input type="text" name="nama_pasangan" id="nama_pasangan" class="form-control" value="<?php echo $row['nama_pasangan']; ?>">
						</div>  

                        <div class="form-group">
							<label>Nama Ibu Kandung <span class="text-danger">*</span></label>
							<input type="text" name="nama_ibu_kandung" id="nama_ibu_kandung" class="form-control" value="<?php echo $row['nama_ibu_kandung']; ?>">
						</div>
                        <div class="form-group">
							<label>Jumlah Anak<span class="text-danger">*</span></label>
							<input type="text" name="jumlah_anak" id="jumlah_anak" class="form-control" value="<?php echo $row['jumlah_anak']; ?>">
						</div>
						<div class="form-group">
