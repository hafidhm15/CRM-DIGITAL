        ...
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Transaksi">
            ...
            <ul class="sidenav-second-level collapse" id="collapseTran">
              <li>
                <a href="buku-tamu.php">Pengaduan Peserta</a>
              </li>
            </ul>
          </li>
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <?php
          ...
          ?>
          <div class="col-xl-4 col-sm-8 mb-3" style="margin-left:400px;">
            <div class="card text-white bg-primary o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="aktivasi.php">
