...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <body style="background:white;">
                        ...
                        <h2 style="margin-top:5%; margin-left:20px;">Cara Menggunakan Layanan Call Center dan Email </h2>
                        <br>
                            <img src="img/caracsdanemail.jpg" width="60%" class="img-responsive" alt="Responsive image" style="margin-left:20px;">
                        <br>
                        <br>
                            ...
                            <p>4.Buka halaman layanan customer service dan email di navigasi layanan untuk menggunakan layanan</p>
                            <p>5.Ikuti nomor yang muncul untuk melakukan panggilan dan klik tombol kirim email untuk mengirim email</p>
                            <p>6.Selesai dan permasalahan anda terjawab dan terkirim </p>
