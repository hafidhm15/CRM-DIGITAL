...
<br>
	<div class="container">
		...
		<h1><a href="https://learncodeweb.com/php/php-crud-in-bootstrap-3-with-a-search-functionality/">Tambah Data Keluarga</a></h1>
		<?php
        ...
        <?php
			...
			if(!empty($submit)){
            $simpan = mysql_query("INSERT INTO data_keluarga VALUES('$nik', '$nomor_kk', '$hubungan_keluarga','$nama_pasangan','$nama_ibu_kandung', '$jumlah_anak', now())");
				 if($simpan==true) {
		...
		<div class="panel panel-default">
			<div class="panel-heading clearfix"><i class="fa fa-fw fa-plus-circle"></i> <strong>Tambah Data Data</strong> <a href="datakeluarga.php" class="pull-right btn btn-danger btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Data Keluarga </a></div>
				...
				<div class="col-sm-6">
					<form method="post">
                        ...
                        <div class="form-group">
							...
							<input type="text" name="nomor_kk" id="nomor_kk" class="form-control" placeholder="Masukkan Nomor KK" required>
						</div>
                        <div class="form-group">
							<label>Status Hubungan Dalam Keluarga <span class="text-danger">*</span></label>
							<input type="text" name="hubungan_keluarga" id="hubungan_keluarga" class="form-control" placeholder="Masukkan Hubungan Keluarga" required>
						</div> 
                        <div class="form-group">
							<label>Nama Pasangan <span class="text-danger">*</span></label>
							<input type="text" name="nama_pasangan" id="nama_pasangan" class="form-control" placeholder="Masukkan Nama Pasangan" required>
						</div>  

                        <div class="form-group">
							<label>Nama Ibu Kandung <span class="text-danger">*</span></label>
							<input type="text" name="nama_ibu_kandung" id="nama_ibu_kandung" class="form-control" placeholder="Masukkan Nama Ibu Kandung" required>
						</div>
                        <div class="form-group">
							<label>Jumlah Anak<span class="text-danger">*</span></label>
							<input type="text" name="jumlah_anak" id="jumlah_anak" class="form-control" placeholder="Masukkan Jumlah Anak" required>
						</div>
						<div class="form-group">
