...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <body style="background:white;">
                        ...
                        <h2 style="margin-top:5%; margin-left:20px;">Cara Menggunakan Layanan Chat </h2>
                        <br>
                            <img src="img/layananchat.jpg" width="60%" class="img-responsive" alt="Responsive image" style="margin-left:20px;">
                        <br>
                        <br>
                            ...
                            <p>3.Masuk ke halaman data peserta untuk mengisi kelengkapan data peserta</p>
                            <p>4.Buka halaman layanan chat di navigasi layanan untuk menggunakan layanan</p>
                            <p>5.Silahkan mulai chat dengan klik tombol klik disini untuk memulai chat dengan customer service </p>
                            <p>6.Selesai dan permasalahan akan dijawab</p>
