...
<br>
	<div class="container">
		...
		<h1><a href="https://learncodeweb.com/php/php-crud-in-bootstrap-3-with-a-search-functionality/">Tambah Data Pekerjaan</a></h1>
        ...
        <?php
			...
			if(!empty($submit)){
            $simpan = mysql_query("INSERT INTO data_pekerjaan VALUES('$nik', '$nomor_pegawai', '$jabatan','$tanggal_mulai_kerja','$batas_usia_pensiun', '$status_kerja', ' $instansi_kerja', '$penghasilan_bersih', '$rekening_bank', '$nama_bank', now())");
				 if($simpan==true) {
		...
		<div class="panel panel-default">
			<div class="panel-heading clearfix"><i class="fa fa-fw fa-plus-circle"></i> <strong>Tambah Data Data</strong> <a href="datapekerjaan.php" class="pull-right btn btn-danger btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Data Pekerjaan </a></div>
				...
				<div class="col-sm-6">
					<form method="post">
                        ...
                        <div class="form-group">
							...
							<input type="text" name="nomor_pegawai" id="nomor_pegawai" class="form-control" placeholder="Masukkan Nomor Pegawai" required>
						</div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
							...
							<input type="text" name="batas_usia_pensiun" id="batas_usia_pensiun" class="form-control" placeholder="Masukkan Batas Tahun Pensiun " required>
						</div>  
                        <br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
							...
							<input type="text" name="instansi_kerja" id="instansi_kerja" class="form-control" placeholder="Masukkan Instansi Kerja" required>
						</div>
                        <div class="form-group">
							<label>Penghasilan Bersih<span class="text-danger">*</span></label>
							<input type="text" name="penghasilan_bersih" id="penghasilan_bersih" class="form-control" placeholder="Masukkan Penghasilan Bersih" required>
						</div>
                        <div class="form-group">
							<label>Rekening Bank<span class="text-danger">*</span></label>
							<input type="text" name="rekening_bank" id="rekening_bank" class="form-control" placeholder="Masukkan Rekening Bank" required>
						</div>
						<div class="form-group">
