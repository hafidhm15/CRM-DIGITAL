...
<br>
	<div class="container">
		...
		<h1><a href="https://learncodeweb.com/php/php-crud-in-bootstrap-3-with-a-search-functionality/">Edit Data Alamat</a></h1>

        <?php

			$nik = $_GET['nik'];				
			$query_mysql = mysql_query("SELECT * FROM data_alamat WHERE nik='$nik'")or die(mysql_error());
			while($row = mysql_fetch_array($query_mysql)){
			?>
			<div class="panel panel-default">
			<div class="panel-heading clearfix"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Data</strong> <a href="dataalamat.php" class="pull-right btn btn-danger btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Data Alamat</a></div>
			<div class="panel-body">
				<div class="col-sm-6">
					<form  action="edit2-proses.php" method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="alamat1" id="alamat1" class="form-control" value="<?php echo $row['alamat1']; ?>">
						</div>
                        <div class="form-group">
							<label>Alamat 2<span class="text-danger">*</span></label>
							<input type="text" name="alamat2" id="alamat2" class="form-control" value="<?php echo $row['alamat2']; ?>">
						</div>
                        <div class="form-group">
							<label>Alamat 3 <span class="text-danger">*</span></label>
							<input type="text" name="alamat3" id="alamat3" class="form-control" value="<?php echo $row['alamat3']; ?>">
						</div>
                        <div class="form-group">
							<label>Alamat 4 <span class="text-danger">*</span></label>
							<input type="text" name="alamat4" id="alamat4" class="form-control" value="<?php echo $row['alamat4']; ?>">
						</div>
                        <div class="form-group">
							<label>Kelurahan<span class="text-danger">*</span></label>
							<input type="text" name="kelurahan" id="kelurahan" class="form-control" value="<?php echo $row['kelurahan']; ?>">
						</div>
                        <div class="form-group">
							<label>kecamatan<span class="text-danger">*</span></label>
							<input type="text" name="kecamatan" id="kecamatan" class="form-control" value="<?php echo $row['kecamatan']; ?>">
						</div>
                        <div class="form-group">
							<label>Kabupaten Kota<span class="text-danger">*</span></label>
							<input type="text" name="kab_kota" id="kab_kota" class="form-control" value="<?php echo $row['kab_kota']; ?>">
						</div>
                        <div class="form-group">
							<label>Provinsi<span class="text-danger">*</span></label>
							<input type="text" name="provinsi" id="provinsi" class="form-control" value="<?php echo $row['provinsi']; ?>">
						</div>
                        <div class="form-group">
							<label>Kode Pos<span class="text-danger">*</span></label>
							<input type="text" name="kode_pos" id="kode_pos" class="form-control" value="<?php echo $row['kode_pos']; ?>">
						</div> 
						<div class="form-group">
